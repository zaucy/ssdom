...
class ServerSideDOMRequestHandler {
  ...
  get scriptsDir() {
    return path.resolve(this.baseDir, defaultConfig.path.scripts);
  }
  ...
  loadMarkup(markup) {
    ...
    var doc = jsdom.jsdom(markup, {
      ...
      created: function(err, window) {
        ...
        self.window = window;
        window.ssdom = {
          loadContent: self.loadContent.bind(self),
          loadData: self.loadData.bind(self),
          changeLocation: self.changeLocation.bind(self)
        };
        
        window.loadContent = function() {
          console.warn("loadContent() is deprecated please use ssdom.loadContent() instead.");
          window.ssdom.loadContent.apply(this, arguments);
        }.bind(self);

        window.loadData = function() {
          console.warn("loadData() is deprecated please use ssdom.loadData() instead.");
          window.ssdom.loadData.apply(this, arguments);
        }.bind(self);

        window.changeLocation = function() {
          console.warn("changeLocation() is deprecated please use ssdom.changeLocation() instead.");
          window.ssdom.changeLocation.apply(this, arguments);
        }.bind(self);
      },
